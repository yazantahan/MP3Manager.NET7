                    ...
                    if (mp3Engine.validateMP3File(selected_index) == MP3Engine.FILE_EXISTS)
                    {
                        ...
                        while (true)
                        {
                            ...
                            if (choice == 1)
                            {
                                ...
                                Console.WriteLine("Would you like to get the lyrics from the Internet? (Internet Required!) (Type Y if you want)");
                                ...
                                if (!string.IsNullOrEmpty(artist) && !string.IsNullOrEmpty(title))
                                {
                                    ...
                                    mp3Engine.editMP3Info(artist, title, selected_index, getLyrics);
                            ...
                            else if (choice == 3)
                            {
                                ...
                                Prog.isAsync = false;
                                Console.WriteLine("Editing the .mp3 info");
                                mp3Engine.editMP3Info(artist, title, album, selected_index, getLyrics);
